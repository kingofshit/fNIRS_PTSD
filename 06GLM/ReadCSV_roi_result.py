            ...
            if int(oxytype) == plot_oxy_type:
                if PTSD_p_value < 0.05:
                    ...
                    if PTSDperiod1_test_pvalue > 0.05 and PTSDperiod2_test_pvalue > 0.05:
                        ...
                        print('- PTSD配对t检验显著： ' + oxy_label + '_' + roi_name + '_' + Beta_list[int(beta1)] + '_' + Beta_list[int(beta2)] + ': ' + str(
                            PTSD_p_value))
                ...
                if HC_p_value < 0.05:
                    ...
                    if HCperiod1_test_pvalue > 0.05 and HCperiod2_test_pvalue > 0.05:
                        ...
                        print('- HC配对t检验显著： ' + oxy_label + '_' + roi_name + '_' + Beta_list[int(beta1)] + '_' +Beta_list[int(beta2)] + ': ' + str(
                            PTSD_p_value))
            ...
            if int(oxytype) == plot_oxy_type:
                if t_p_value < 0.05:
                    ...
                    if PTSD_test_pvalue > 0.05 and HC_test_pvalue > 0.05:
                        ...
                        print('- 独立样本t检验显著： ' + oxy_label + '_' + roi_name + '_' + Beta_list[int(beta)] + ': ' + str(t_p_value))
                if mannwhitneyu_p_value < 0.05:
                    oxy_sum[plot_oxy_type - 1, 2] += 1
                    roi_sum[int(roi - 1), 2] += 1
                    beta_sum[int(beta), 2] += 1
                    print('- mannwhitney u检验显著： ' + oxy_label + '_' + roi_name + '_' + Beta_list[int(beta)] + ': ' + str(mannwhitneyu_p_value))
