...
feature_path = r'C:\Users\wjy\OneDrive - hdu.edu.cn\研究生\大论文\fNIRS_Py\01mean'
            ...
            for period_num in range(1, 7):
                for another_period_num in range(period_num, 7):
                    if period_num == another_period_num:
                        ...
                        ptsd_sub_task = sum(PTSDperiod2)/len(PTSDperiod2) - sum(PTSDperiod1)/len(PTSDperiod1)
                        hc_sub_task = sum(HCperiod2)/len(HCperiod2) - sum(HCperiod1)/len(HCperiod1)
                        ...
                        result_array[
                            (oxy_num - 1) * 48 * 15 + (channel_num - 1) * 15 + pair_no, 4] = ptsd_sub_task
                        result_array[
                            (oxy_num - 1) * 48 * 15 + (channel_num - 1) * 15 + pair_no, 5] = ptsd_sub_task
                        ...
                        result_array[
                            (oxy_num - 1) * 48 * 15 + (channel_num - 1) * 15 + pair_no, 8] = hc_sub_task
                        result_array[
                            (oxy_num - 1) * 48 * 15 + (channel_num - 1) * 15 + pair_no, 9] = hc_sub_task
